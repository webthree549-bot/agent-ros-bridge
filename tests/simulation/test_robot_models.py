...
class TestTurtleBotModel:
    ...
    def test_turtlebot_spawns_correctly(self):
        ...
        assert "libgazebo_ros_joint_state_publisher.so" in plugin_filenames, "Missing joint state publisher"
        ...
        for model_path in models_dir.iterdir():
            if model_path.is_dir():
                ...
                if config_path.exists():
                    ...
                    assert root.find("description") is not None, f"{model_path.name}: missing description"
