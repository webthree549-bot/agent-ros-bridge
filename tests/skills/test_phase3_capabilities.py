...
class TestSkillFulfillmentPhase3:
    ...
    def test_closest_robot_selection_fulfilled(self):
        ...
        fleet.update_robot_state(RobotState(
            robot_id="r1", name="R1", status=RobotStatus.IDLE,
            position={"x": 0, "y": 0}, battery_percent=50,
    ...
    def test_best_battery_selection_fulfilled(self):
        ...
        fleet.update_robot_state(RobotState(
            robot_id="r2", name="R2", status=RobotStatus.IDLE,
            position={"x": 0, "y": 0}, battery_percent=80,
            capabilities=RobotCapabilities()
        ))
