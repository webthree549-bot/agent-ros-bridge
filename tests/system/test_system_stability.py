        ...
        try:
            ...
            for i in range(1000):
                ...
                try:
                    ...
                    assert response.intent.type in [
                        "NAVIGATE",
                        "MANIPULATE",
                        "SENSE",
                        "QUERY",
...
class TestMultiRobotCoordination:
    ...
    def test_concurrent_intent_parsing(self):
        ...
        try:
            ...
            robots = [(f"robot_{i:02d}", f"go to location_{i}") for i in range(10)]

            with ThreadPoolExecutor(max_workers=10) as executor:
                futures = [executor.submit(parse_for_robot, rid, utt) for rid, utt in robots]
