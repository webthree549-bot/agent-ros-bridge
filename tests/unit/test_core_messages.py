...
class TestIdentity:
    ...
    def test_identity_creation(self):
        ...
        identity = Identity(id="user_123", name="Test User", roles=["operator", "viewer"])
    ...
    def test_identity_has_role(self):
        ...
        identity = Identity(id="user_789", name="Role Tester", roles=["admin", "operator"])
...
class TestHeader:
    ...
    def test_header_default_values(self):
        ...
        assert (datetime.now(UTC) - header.timestamp) < timedelta(seconds=1)
...
class TestCommand:
    ...
    def test_command_creation(self):
        ...
        cmd = Command(action="move", parameters={"x": 10, "y": 20, "speed": 1.5})
...
class TestTelemetry:
    ...
    def test_telemetry_creation(self):
        ...
        telemetry = Telemetry(topic="/robot/odom", data={"x": 1.5, "y": 2.5, "theta": 0.5})
...
class TestEvent:
    ...
    def test_event_creation(self):
        ...
        event = Event(
            event_type="robot_connected", data={"robot_id": "robot_1", "ip": "192.168.1.10"}
        )
...
class TestMessage:
    ...
    def test_message_with_command(self):
        ...
        msg = Message(
            ...
            command=Command(action="move_forward", parameters={"distance": 1.0}),
        )
    ...
    def test_message_with_telemetry(self):
        ...
        msg = Message(
            ...
            telemetry=Telemetry(topic="/battery", data={"level": 85.5, "voltage": 12.4}),
        )
    ...
    def test_message_correlation_id_propagation(self):
        ...
        # Create request
        request = Message(
            header=Header(message_id=request_id), command=Command(action="get_status")
        )

        # Create response with correlation to request
        response = Message(
            header=Header(message_id=str(uuid.uuid4()), correlation_id=request_id),
    ...
    def test_message_complete_flow(self):
        ...
        response_msg = Message(
            ...
            telemetry=Telemetry(topic="navigation_result", data={"status": "started", "eta": 30}),
        )
...
class TestMessageDataclassFeatures:
    ...
    def test_message_asdict_conversion(self):
        ...
        msg = Message(header=Header(message_id="test_123"), command=Command(action="test"))
