...
class TestBatchExecution10K:
    ...
    def test_reports_progress(self):
        ...
        with patch.object(gen, "_execute_single") as mock_exec:
            ...
            gen.execute_batch(
                scenario_files=["s1.yaml", "s2.yaml", "s3.yaml"], progress_callback=capture_progress
            )
...
class TestGate2Validation:
    ...
    def test_validates_success_rate(self):
        ...
        # Simulate 96% success
        results = [{"success": True} for _ in range(9600)] + [
    ...
    def test_fails_below_95_percent(self):
        ...
        results = [{"success": True} for _ in range(9400)] + [
    ...
    def test_validates_zero_safety_violations(self):
        ...
        results = [{"success": True, "safety_violations": 0} for _ in range(10000)]
    ...
    def test_fails_on_safety_violations(self):
        ...
        results = [{"success": True, "safety_violations": 0} for _ in range(9999)] + [
...
class TestMetricsReporting:
    ...
    def test_calculates_average_duration(self):
        ...
        results = [{"success": True, "duration": 10.0} for _ in range(5000)] + [
    ...
    def test_calculates_collision_rate(self):
        ...
        results = [{"success": True, "collision_count": 0} for _ in range(9900)] + [
    ...
    def test_tracks_failure_reasons(self):
        ...
        results = [{"success": False, "error": "timeout"} for _ in range(200)] + [
...
class TestReportGeneration:
    ...
    def test_generates_html_report(self):
        ...
        results = [
            {"success": True, "duration": 10.0, "collision_count": 0} for _ in range(9600)
        ] + [{"success": False, "duration": 5.0, "collision_count": 1} for _ in range(400)]
