...
class TestPickObjectPrimitive:
    ...
    def test_pick_object_accepts_custom_gripper_force(self):
        ...
        grasp_pose = MagicMock()
        primitive = PickObjectPrimitive(object_id="obj_123", grasp_pose=grasp_pose, gripper_force=20.0)
    ...
    def test_pick_object_rejects_invalid_gripper_force(self):
        ...
        grasp_pose = MagicMock()
        primitive = PickObjectPrimitive(object_id="obj_123", grasp_pose=grasp_pose, gripper_force=0.0)
...
class TestMotionPrimitiveFactory:
    ...
    def test_factory_creates_navigate_primitive(self):
        ...
        from agent_ros_bridge.ai.motion_primitives import MotionPrimitiveFactory, NavigateToPosePrimitive
    ...
    def test_factory_creates_pick_primitive(self):
        ...
        from agent_ros_bridge.ai.motion_primitives import MotionPrimitiveFactory, PickObjectPrimitive
