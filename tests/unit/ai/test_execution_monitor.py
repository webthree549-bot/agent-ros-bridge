...
class TestExecuteMotion:
    ...
    async def test_execute_navigate_motion(self):
        ...
        plan = MotionPlan(
            ...
            safety_certificate=SafetyCertificate(valid=True)
        )
...
class TestRecoveryStrategies:
    ...
    async def test_triggers_recovery_on_stuck(self):
        ...
        anomaly = Anomaly(
            ...
            description="Robot stuck for 10s",
            severity="HIGH"
        )
    ...
    async def test_triggers_recovery_on_deviation(self):
        ...
        anomaly = Anomaly(
            ...
            description="Path deviation detected",
            severity="MEDIUM"
        )
...
class TestRecoveryHandler:
    ...
    async def test_recovery_handler_handles_stuck(self):
        ...
        from agent_ros_bridge.ai.execution_monitor import RecoveryHandler, Anomaly, AnomalyType
    ...
    async def test_recovery_handler_handles_deviation(self):
        ...
        assert result.success is True
        assert "relocalize" in result.action_taken.lower() or "resume" in result.action_taken.lower()
