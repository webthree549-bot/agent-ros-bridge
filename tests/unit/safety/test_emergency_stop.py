...
class TestTriggerEmergencyStopService:
    ...
    def test_trigger_emergency_stop_service_available(self):
        ...
        assert hasattr(EmergencyStopNode, 'TRIGGER_SERVICE') or \
               hasattr(EmergencyStopNode, 'trigger_emergency_stop'), \
    ...
    def test_clear_emergency_stop_service_available(self):
        ...
        assert hasattr(EmergencyStopNode, 'CLEAR_SERVICE') or \
               hasattr(EmergencyStopNode, 'clear_emergency_stop'), \
