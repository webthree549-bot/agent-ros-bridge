...
class TestTransportLifecycle:
    ...
    async def test_start_without_websockets(self):
        ...
        with mock.patch("agent_ros_bridge.gateway_v2.transports.websocket.WEBSOCKETS_AVAILABLE", False):
            transport = WebSocketTransport({})
...
class TestErrorHandling:
    ...
    async def test_broadcast_handles_send_errors(self, transport):
        ...
        from agent_ros_bridge.gateway_v2.core import Message, Header, Telemetry
