...
pytestmark = pytest.mark.skipif(
    not pytest.importorskip("rclpy", reason="ROS2 not available"),
...
class TestEndToEndSystem:
    ...
    async def test_error_handling(self, system):
        ...
        from agent_ros_bridge.utils.error_handling import (
            AgentError, ErrorCode, InputValidator
        )
    ...
    async def test_blueprint_autoconnect(self, system):
        ...
        from agent_ros_bridge.gateway_v2 import (
            Blueprint, Module, In, Out, autoconnect
        )
...
class TestProductionReadiness:
    ...
    def test_blueprint_system_importable(self):
        ...
        from agent_ros_bridge.gateway_v2 import (
            Blueprint, Module, In, Out, autoconnect, skill, rpc
        )
