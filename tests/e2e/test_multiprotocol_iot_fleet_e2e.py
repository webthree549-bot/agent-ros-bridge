...
class TestGRPCTransportE2E:
    ...
    async def test_grpc_connection(self, gateway_running):
        ...
        try:
            import grpc
            from agent_ros_bridge.integrations import ros2_pb2
            from agent_ros_bridge.integrations import ros2_pb2_grpc
