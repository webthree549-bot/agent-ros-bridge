...
from agent_ros_bridge.gateway_v2.core import Command, Header, Identity, Message, Transport
...
class BridgeServiceServicer(bridge_pb2.BridgeServiceServicer if GRPC_AVAILABLE else object):
    ...
    def _message_to_proto_response(self, message: Message) -> bridge_pb2.CommandResponse:
        ...
        return bridge_pb2.CommandResponse(success=True, result=result_struct, error="")
...
async def example_server():
    ...
    grpc_transport = GRPCTransport({"host": "0.0.0.0", "port": 50051, "reflection": True})
