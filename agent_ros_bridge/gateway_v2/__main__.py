...
from agent_ros_bridge.gateway_v2.config import (BridgeConfig,  # noqa: E402
                                                ConfigLoader)
from agent_ros_bridge.gateway_v2.connectors.ros2_connector import \
    ROS2Connector  # noqa: E402
from agent_ros_bridge.gateway_v2.core import Bridge  # noqa: E402
from agent_ros_bridge.gateway_v2.plugins.greenhouse_plugin import \
    GreenhousePlugin  # noqa: E402
from agent_ros_bridge.gateway_v2.transports.grpc_transport import \
    GRPCTransport  # noqa: E402
...
def create_bridge_from_config(config: BridgeConfig) -> Bridge:
    ...
    for plugin_cfg in config.plugins:
        ...
        if plugin_cfg.name == "greenhouse":
            ...
            logger.info("Loaded greenhouse plugin")
...
Environment Variables:
  ...
  BRIDGE_JWT_SECRET       JWT secret for authentication (required)
    ...
    parser.add_argument("--websocket-port", type=int, help="WebSocket port (overrides config)")

    parser.add_argument("--grpc-port", type=int, help="gRPC port (overrides config)")
    ...
    parser.add_argument("--version", "-v", action="version", version="Agent ROS Bridge 0.5.0")
