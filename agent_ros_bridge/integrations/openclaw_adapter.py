...
class OpenClawAdapter:
    ...
    DEFAULT_TOOLS = [
        ...
        },
        {
            ...
            "parameters": {
                ...
                "service_type": {
                    "type": "string",
                    "description": "Service type (e.g., turtlesim/srv/Spawn)",
                },
        ...
        },
        {
            ...
            "parameters": {
                "action_name": {
                    "type": "string",
                    "description": "Action server name (e.g., /navigate_to_pose)",
                },
        ...
        },
        {
            ...
            "parameters": {
                "camera_topic": {
                    "type": "string",
                    "description": "Camera topic (e.g., /camera/image_raw)",
                },
                "encoding": {
                    "type": "string",
    ...
    EXTENDED_TOOLS = [
        ...
        },
        {
            ...
            "parameters": {
                "task_type": {
                    "type": "string",
                    "description": "Task type (navigate, pickup, etc.)",
                },
                "target_location": {
                    "type": "string",
                    "description": "Target location or coordinates",
                },
                "priority": {
                    "type": "integer",
                    "description": "Task priority (1-10, lower is higher)",
                    "default": 5,
                },
            },
            "dangerous": False,
    ...
    def enable_natural_language(self):
        ...
        self.contextual_interpreter = ContextAwareNLInterpreter(
            self.nl_interpreter, self.context_manager
        )
    ...
    async def execute_nl(self, nl_command: str, session_id: str = "default") -> Dict[str, Any]:
        ...
        # Log to context
        self.context_manager.log_interaction(session_id, nl_command, interpretation, result)
