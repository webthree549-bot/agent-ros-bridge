...
class FleetIntelligence:
    ...
    def calculate_distance(self, pos1: Dict[str, float], 
    ...
    def get_distance_to_location(self, robot_id: str, 
                                 location_name: str) -> Optional[float]:
    ...
    def select_best_robot(self, task: Dict[str, Any], 
                         criteria: List[str] = None) -> Optional[str]:
        ...
        available = [
            r for r in self.robot_states.values()
    ...
    def get_robot_with_most_battery(self) -> Optional[str]:
        ...
        return max(
            self.robot_states.values(),
            key=lambda r: r.battery_percent
        ).robot_id
    ...
    def plan_coordination(self, task_type: str, 
                         robots: List[str] = None) -> Dict[str, Any]:
        ...
        if robots is None:
            robots = [
                r.robot_id for r in self.robot_states.values()
                if r.status == RobotStatus.IDLE
            ]
    ...
    def get_fleet_summary(self) -> Dict[str, Any]:
        ...
        avg_battery = sum(
            r.battery_percent for r in self.robot_states.values()
...
def find_closest_robot_to_location(fleet: FleetIntelligence, 
