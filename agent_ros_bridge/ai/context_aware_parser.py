...
class ContextAwareParser:
    ...
    def update_robot_state(self, location: Optional[str] = None,
    ...
    def update_environment(self, locations: Optional[List[str]] = None,
    ...
    def _resolve_here(self) -> Optional[str]:
        ...
        return self._robot_state.location if self._robot_state.location != "unknown" else "current location"
    ...
    def enhance_intent(self, intent_type: str, entities: List[Dict[str, Any]], 
