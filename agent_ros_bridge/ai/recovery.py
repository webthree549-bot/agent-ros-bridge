...
class ObstacleRecovery:
    ...
    async def execute(self) -> Dict[str, Any]:
        ...
        if wait_success:
            return {
                "success": True,
                "action": "waited_for_obstacle_to_clear"
            }
        ...
        return {
            "success": True,
            "action": "replanned_around_obstacle"
        }
...
class TimeoutRecovery:
    ...
    async def execute(self) -> Dict[str, Any]:
        ...
        return {
            "success": True,
            "action": "aborted_and_notified",
            "notified": self.notify_operator
        }
